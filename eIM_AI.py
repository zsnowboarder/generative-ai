...
def generate(inst_text, prompt_text):
    if no_credits == True:
     return "Account low in credit balance. User has disconnected connection to Vertex AI services."
...
st.markdown("<h3>Account low in balance</h3>", unsafe_allow_html=True)
st.markdown("<h3>[Click here to use the free version](https://eim-api.streamlit.app/)</h3>", unsafe_allow_html=True)
st.write('')
